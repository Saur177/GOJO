...
interface DevelopaecommercewebsiteormakecloneofflipkartComponentProps {
  title?: string;
...
export default function DevelopaecommercewebsiteormakecloneofflipkartComponent({
  title = 'Develop a ecommerce website or make clone of flipkart',
  onSuccess,
  onError,
  className = ''
}: DevelopaecommercewebsiteormakecloneofflipkartComponentProps) {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = {
        message: 'Develop a ecommerce website or make clone of flipkart completed successfully!',
