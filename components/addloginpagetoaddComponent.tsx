...
interface addloginpagetoaddComponentProps {
  title?: string;
...
export default function addloginpagetoaddComponent({
  title = 'add login page to add',
  onSuccess,
  onError,
  className = ''
}: addloginpagetoaddComponentProps) {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = {
        message: 'add login page to add completed successfully!',
